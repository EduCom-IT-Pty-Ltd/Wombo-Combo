...
export default async function SchedulePage() {
  ...
  return <div className="space-y-4"><PageHeader title="Calendar" description="Project Call-Ups by day, week, or month." /><PhaseCalendar phases={phases} people={people} /></div>;
}
