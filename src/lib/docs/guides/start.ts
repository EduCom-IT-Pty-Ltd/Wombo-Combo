          ...
          },
          {
            ...
            rows: [
              ...
              [
                ...
                "Production templates and price lists do most of the work for you.",
              ],
              [
                "Scheduler",
        ...
        blocks: [
          ...
          },
          {
            ...
            items: [
              ...
              "**Production templates**: build the reusable material models estimators will quote from.",
          ...
          },
          {
            ...
            body: "Only the organisation settings really need to be right up front. Production templates, labour rates and workflow checklists can all be filled in as you go — the app works without them, it just does less for you.",
          },
        ],
      },
    ],
        ...
        blocks: [
          ...
          },
          {
            ...
            rows: [
              ...
              ["Quote", "Build a material quote from production templates, then send it to Xero."],
              ...
              ["Documents", "The SharePoint folder plus drawings, SWMS, permits and certificates."],
